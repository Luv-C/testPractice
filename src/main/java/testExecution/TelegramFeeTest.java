...
public class TelegramFeeTest {
    public final String filePath="src/main/resources/telegramFeeTestCases.xlsx";
    public void executeOne(int number){
        ...
        //执行测试用例
        TelegramFee telegramFee=new TelegramFee();
        String result=""+telegramFee.calculate(para1,para2);
        //写入测试用例执行结果
        try{
